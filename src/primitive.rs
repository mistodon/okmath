...
mod tests
{
    ...
    {
        assert_eq!((-1.0).as_u8(), std::u8::MAX);
        assert_eq!((-1.0).as_u16(), std::u16::MAX);
        assert_eq!((-1.0).as_u32(), std::u32::MAX);
        assert_eq!((-1.0).as_u64(), std::u64::MAX);
        assert_eq!((-1.0).as_usize(), std::usize::MAX);
        assert_eq!((-1.0).as_i8(), -1_i8);
        assert_eq!((-1.0).as_i16(), -1_i16);
        assert_eq!((-1.0).as_i32(), -1_i32);
        assert_eq!((-1.0).as_i64(), -1_i64);
